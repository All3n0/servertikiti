...
CORS(app, supports_credentials=True, origins=['http://localhost:3000', 'https://tikiti.vercel.app'])
...
def set_user_cookie(response, user, extra_data=None):
    ...
    response.set_cookie(
        ...
        secure=True,
        samesite='None',
        domain='servertikiti-production.up.railway.app',  # Critical for production
        max_age=3600
    )
